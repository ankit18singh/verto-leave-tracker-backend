...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.downloadGo = exports.createGo = exports.getAnalyzedEntrypoint = exports.OUT_EXTENSION = void 0;
...
async function getAnalyzedEntrypoint(filePath, modulePath = '') {
...
async function createGo(goPath, platform = process.platform, arch = process.arch, opts = {}, goMod = false) {
    const path = `${path_1.dirname(GO_BIN)}:${process.env.PATH}`;
    const env = {
        ...process.env,
        PATH: path,
        GOPATH: goPath,
...
async function downloadGo(dir = GO_DIR, version = '1.13.7', platform = process.platform, arch = process.arch) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.startDevServer = exports.build = exports.version = exports.shouldServe = void 0;
const execa_1 = __importDefault(__webpack_require__(580));
...
`);
    ...
    try {
        ...
        analyzed = await go_helpers_1.getAnalyzedEntrypoint(downloadedFiles[entrypoint].fsPath, goModAbsPathDir);
    }
    catch (err) {
...
Learn more: https://vercel.com/docs/runtimes#official-runtimes/go
    ...
    if (meta.isDev) {
        ...
        goPath = path_1.join(devCacheDir, 'now-go', path_1.basename(entrypoint, '.go'));
    ...
    if (packageName !== 'main') {
        const go = await go_helpers_1.createGo(goPath, process.platform, process.arch, {
...
async function startDevServer(opts) {
    ...
    const analyzedRaw = await go_helpers_1.getAnalyzedEntrypoint(entrypointWithExt, goModAbsPathDir);
    if (!analyzedRaw) {
